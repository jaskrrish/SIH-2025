  ...
  return (
    <div className="flex flex-col justify-center items-center mt-10">
      ...
      <div className="relative grid  grid-cols-2 gap-4 p-4 mt-10 ">
        ...
        <div className="absolute w-px h-40 bg-gradient-to-t from-transparent via-gray-200 to-transparent left-[50%] top-[20%]"></div>
        <div className="absolute h-px w-50 bg-gradient-to-r from-transparent via-gray-200 to-transparent top-[50%] left-[40%] "></div>
      </div>
    </div>
  );
};
...
export const Heading = ({
  ...
  return (
    <p
      className={`${className} text-4xl bg-gradient-to-r from-deep-navy via-tech-blue to-deep-navy bg-clip-text text-transparent font-bold`}
    >
      {children}
    </p>
  );
