...
import { ShieldCheck, Lock, User, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react';
...
export default function Auth({ onLogin }: AuthProps) {
    ...
    return (
        <div className="min-h-screen w-full flex bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            {/* Left Panel - Branding */}
                ...
                <div className="relative z-10 max-w-md space-y-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-white/80 text-sm">Quantum Secure Communication</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-white/90 text-lg leading-relaxed">
                            Experience unbreakable security powered by Quantum Key Distribution (QKD) technology.
                            Your messages are protected by the laws of physics.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4 pt-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="text-white font-semibold">Quantum Key Distribution</h3>
                                <p className="text-white/70 text-sm">Unbreakable encryption using quantum mechanics</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-white/70 text-sm">Your data is encrypted at all stages</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="text-white font-semibold">Future-Proof Security</h3>
                                <p className="text-white/70 text-sm">Protected against quantum computer attacks</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            name="username"
                                            type="text"
                                            placeholder={mode === 'signup' ? 'johndoe' : 'Your username'}
                                ...
                                <Button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full bg-gradient-to-r from-[#f4711b] to-orange-600 hover:from-[#f4711b]/90 hover:to-orange-600/90 text-white shadow-lg shadow-orange-500/25 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
                                    size="lg"
                                >
                                    {loading ? 'Please wait...' : mode === 'login' ? 'Sign In' : 'Create My QuteMail Account'}
                            ...
                            <div className="mt-6 text-center">
                                <p className="text-sm text-muted-foreground">
                                    {mode === 'login' ? "Don't have a QuteMail account?" : 'Already have a QuteMail account?'}
                                    {' '}
                                    <button
                                        type="button"
                                        onClick={toggleMode}
